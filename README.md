# GarageMQ [![Build Status](https://github.com/oarkflow/garagemq/actions/workflows/build.yml/badge.svg)](https://github.com/oarkflow/garagemq/actions) [![Coverage Status](https://coveralls.io/repos/github/valinurovam/garagemq/badge.svg)](https://coveralls.io/github/valinurovam/garagemq) [![Go Report Card](https://goreportcard.com/badge/github.com/oarkflow/garagemq)](https://goreportcard.com/report/github.com/oarkflow/garagemq)
...
```shell
go get -u github.com/oarkflow/garagemq/...
cd $GOPATH/src/github.com/oarkflow/garagemq
docker build -t garagemq .
docker run --name garagemq -p 5672:5672 -p 15672:15672 garagemq

```
### Go get
You can also use [go get](https://golang.org/cmd/go/#hdr-Download_and_install_packages_and_dependencies): ```go get -u github.com/oarkflow/garagemq/...```
```shell
go get -u github.com/oarkflow/garagemq/...
cd $GOPATH/src/github.com/oarkflow/garagemq
